...
| Project | Description | Stack |
|---|---|---|
| 🔊 **Memory-Augmented Latent Diffusion** · 🔒 Private | Research framework augmenting latent-diffusion audio generation with a retrieval memory bank + conditioning modules and a custom PRISM evaluation suite | PyTorch · Diffusers · Stable Audio · T5 |
| 🤖 **RON — AI Companion** · 🔒 Private | Voice + face AI companion: Whisper STT, Silero VAD, Groq LLM, ElevenLabs TTS, 25+ emotion pixel-art face renderer | Python · pygame · Whisper · ElevenLabs |
