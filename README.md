...
| 🧑‍💼 [AI Recruitment Filtering System](https://github.com/Yaass1ne/RH-recrutement-app) | Automated candidate screening using semantic NLP + GPT-3.5 interview scoring | Flask · spaCy · SBERT · GPT-3.5 |
